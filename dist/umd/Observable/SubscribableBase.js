...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "tslib", "../Collections/LinkedNodeList", "../Disposable/dispose", "./Subscription", "../Disposable/DisposableBase"], factory);
    }
    ...
    var SubscribableBase = /** @class */ (function (_super) {
        ...
        SubscribableBase.prototype._unsubscribeAll = function (returnSubscribers) {
            ...
            _s.clear(); // Reset...
            dispose_1.default.these.noCopy(s);
            return u;
        };
