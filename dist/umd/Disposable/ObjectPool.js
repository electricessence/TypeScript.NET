...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "tslib", "./dispose", "./DisposableBase", "../Threading/Tasks/TaskHandler", "../Exceptions/ArgumentOutOfRangeException", "../Exceptions/ArgumentException"], factory);
    }
    ...
    var ObjectPool = /** @class */ (function (_super) {
        tslib_1.__extends(ObjectPool, _super);
        function ObjectPool(_maxSize, _generator, _recycler) {
            ...
            var _ = _this;
            _this._pool = [];
            _this._trimmer = new TaskHandler_1.default(function () { return _._trim(); });
            var clear = function () { return _._clear(); };
            _this._flusher = new TaskHandler_1.default(clear);
            _this._autoFlusher = new TaskHandler_1.default(clear);
            return _this;
        }
        ...
        ObjectPool.prototype._trim = function () {
            ...
            while (pool.length > this._maxSize) {
                dispose_1.default.single(pool.pop(), true);
            }
        };
        /**
        ...
        ObjectPool.prototype._clear = function () {
            ...
            dispose_1.default.these.noCopy(p, true);
            p.length = 0;
        };
        /**
        ...
        ObjectPool.prototype.take = function (factory) {
            ...
            if (!_._generator && !factory)
                throw new ArgumentException_1.default('factory', "Must provide a factory if on was not provided at construction time.");
            try {
