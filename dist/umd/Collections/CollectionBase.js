...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "tslib", "./Enumeration/Enumerator", "../Comparison/areEqual", "../Exceptions/ArgumentNullException", "../Exceptions/InvalidOperationException", "../Disposable/DisposableBase", "../Environment"], factory);
    }
    ...
    var CollectionBase = /** @class */ (function (_super) {
        ...
        function CollectionBase(source, _equalityComparer) {
            if (_equalityComparer === void 0) { _equalityComparer = areEqual_1.default; }
