...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "tslib", "./LinkedNodeList", "./CollectionBase", "../Exceptions/InvalidOperationException", "../Exceptions/ArgumentNullException", "../Comparison/areEqual"], factory);
    }
    ...
    var LinkedList = /** @class */ (function (_super) {
        tslib_1.__extends(LinkedList, _super);
        function LinkedList(source, equalityComparer) {
            ...
            _this._listInternal = new LinkedNodeList_1.default();
