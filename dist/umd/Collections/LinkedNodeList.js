...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "../Exceptions/InvalidOperationException", "../Exceptions/ArgumentException", "../Exceptions/ArgumentNullException", "./Enumeration/EnumeratorBase", "../Text/supplant"], factory);
    }
    ...
    var supplant_1 = require("../Text/supplant");
    /*****************************
    ...
    var LinkedNodeList = /** @class */ (function () {
        ...
        LinkedNodeList.prototype.removeNode = function (node) {
            ...
            if (next)
                ...
                b = true;
            if (a !== b) {
                throw new ArgumentException_1.default('node', supplant_1.format("Provided node is has no {0} reference but is not the {1} node!", a ? "previous" : "next", a ? "first" : "last"));
            }
            var removed = !a && !b;
            if (removed) {
                _._version++;
