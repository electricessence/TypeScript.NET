...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "tslib", "../../Disposable/DisposableBase", "../../Disposable/ObjectPool", "./IteratorResult"], factory);
    }
    ...
    function yielder(recycle) {
        if (!yielderPool)
            yielderPool
                = new ObjectPool_1.default(40, function () { return new Yielder(); }, function (y) { return y.yieldBreak(); });
        if (!recycle)
    ...
    var EnumeratorBase = /** @class */ (function (_super) {
        tslib_1.__extends(EnumeratorBase, _super);
        function EnumeratorBase(_initializer, _tryGetNext, disposer, isEndless) {
            var _this = _super.call(this, "EnumeratorBase") || this;
        ...
        EnumeratorBase.prototype.next = function () {
            return this.moveNext()
                ? new IteratorResult_1.default(this.current, this.index)
                : IteratorResult_1.CompletedIteratorResult;
        };
        ...
        EnumeratorBase.prototype['return'] = function (value) {
            ...
            try {
                return value === VOID0 || _._state === 2 /* Completed */ || _._state === 4 /* Interrupted */
                    ? IteratorResult_1.CompletedIteratorResult
                    : new IteratorResult_1.default(value, VOID0, true);
            }
            finally {
                _.end();
            }
