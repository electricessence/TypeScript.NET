...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "tslib", "./StringKeyDictionary", "../../Exceptions/ArgumentOutOfRangeException", "../../Integer", "../Array/removeElement"], factory);
    }
    ...
    var OrderedStringKeyDictionary = /** @class */ (function (_super) {
        ...
        OrderedStringKeyDictionary.prototype.getValueByIndex = function (index) {
            ...
            throw new ArgumentOutOfRangeException_1.default('index', index);
        };
        ...
        OrderedStringKeyDictionary.prototype.setValue = function (key, value, keepIndex) {
            ...
            if (!exists && (value !== VOID0 || keepIndex))
                ...
                removeElement_1.default(_._order, key);
