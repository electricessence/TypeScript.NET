...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "tslib", "../../Comparison/areEqual", "./getIdentifier", "../../Reflection/isPrimitiveOrSymbol", "./DictionaryBase", "../Enumeration/EnumeratorBase", "../LinkedNodeList", "../../Disposable/ObjectPool"], factory);
    }
    ...
    var isPrimitiveOrSymbol_1 = require("../../Reflection/isPrimitiveOrSymbol");
    ...
    function linkedNodeList(recycle) {
        if (!linkedListPool)
            linkedListPool
                = new ObjectPool_1.default(20, function () { return new LinkedNodeList_1.default(); }, function (r) { return r.clear(); });
        if (!recycle)
    ...
    var Dictionary = /** @class */ (function (_super) {
        ...
        Dictionary.prototype._getBucket = function (hash, createIfMissing) {
            if (hash == null || !createIfMissing && !this.getCount())
                return null;
            if (!isPrimitiveOrSymbol_1.default(hash))
        ...
        Dictionary.prototype._getBucketEntry = function (key, hash, bucket) {
            ...
            if (!bucket)
                bucket = _._getBucket(hash || getIdentifier_1.default(compareKey));
            return bucket
                && (comparer
        ...
        Dictionary.prototype._setValueInternal = function (key, value) {
            var _ = this;
            var buckets = _._buckets, entries = _._entries, compareKey = _._keyGenerator ? _._keyGenerator(key) : key, hash = getIdentifier_1.default(compareKey);
            ...
            if (bucketEntry) {
                ...
                if (value === VOID0) {
                    ...
                    return !areEqual_1.default(value, old);
                }
            }
            else if (value !== VOID0) {
                if (!bucket)
