...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "tslib", "../Threading/deferImmediate", "../Threading/defer", "./PromiseState"], factory);
    }
    ...
    exports.handleDispatch = handleDispatch;
    ...
    exports.handleResolutionMethods = handleResolutionMethods;
    var PromiseBase = /** @class */ (function (_super) {
        tslib_1.__extends(PromiseBase, _super);
        //readonly [Symbol.toStringTag]: "Promise";
        function PromiseBase() {
            var _this = _super.call(this, PromiseState_1.PromiseStateValue.Pending) || this;
        ...
        return PromiseBase;
    }(PromiseState_1.default));
    exports.default = PromiseBase;
});
