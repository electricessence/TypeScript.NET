...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "tslib", "../Worker", "../../Environment", "../deferImmediate", "../../Disposable/ObjectPool", "../../Promises/Functions/map", "../../Promises/Promise", "../../Promises/PromiseCollection", "../../Promises/ArrayPromise"], factory);
    }
    ...
    var map_1 = require("../../Promises/Functions/map");
    var Promise_1 = require("../../Promises/Promise");
    var PromiseCollection_1 = require("../../Promises/PromiseCollection");
    var ArrayPromise_1 = require("../../Promises/ArrayPromise");
    ...
    var WorkerPromise = /** @class */ (function (_super) {
        tslib_1.__extends(WorkerPromise, _super);
    ...
    (function (workers) {
        ...
        function getPool(key) {
            ...
            if (!pool) {
                workerPools[key] = pool = new ObjectPool_1.default(8);
    ...
    var Parallel = /** @class */ (function () {
        ...
        Parallel.prototype.pipe = function (data, task, env) {
                    ...
                    if (!worker) {
                        if (!this_1.options.allowSynchronous)
                            throw new Error(maxConcurrency
                                ? "Workers do not exist and synchronous operation not allowed!"
                                : "'maxConcurrency' set to 0 but 'allowSynchronous' is false.");
                        return { value: map_1.default(data, task) };
                    }
                    if (!result) {
                        ...
                        result = data.map(function (d) { return new Promise_1.default(); });
                    }
                    var next = function () {
                        if (error_1) {
            ...
            return new PromiseCollection_1.default(result);
        };
        ...
        Parallel.prototype.map = function (data, task, env) {
            var _this = this;
            if (!data || !data.length)
                return ArrayPromise_1.default.fulfilled([]);
            ...
            return new ArrayPromise_1.default(function (resolve, reject) {
                ...
                var _loop_2 = function (w) {
                    ...
                    if (!worker) {
                        ...
                        resolve(map_1.default(data, task).all());
                        return { value: void 0 };
                    }
                    var next = function () {
                        if (error) {
