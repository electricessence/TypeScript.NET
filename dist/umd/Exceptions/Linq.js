...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "tslib", "../Collections/Enumeration/Enumerator", "../Collections/Enumeration/Enumerator", "../Collections/Enumeration/EmptyEnumerator", "../Integer", "../Functions", "../Collections/Enumeration/ArrayEnumerator", "../Collections/Enumeration/EnumeratorBase", "../Collections/Dictionaries/Dictionary", "../Collections/Queue", "../Disposable/dispose", "../Disposable/DisposableBase", "../Collections/Enumeration/UnsupportedEnumerableException", "../Disposable/ObjectDisposedException", "../Collections/Sorting/KeySortedContext", "./ArgumentNullException", "./ArgumentOutOfRangeException", "../Collections/Enumeration/IndexEnumerator", "../Collections/Enumeration/IteratorEnumerator", "../Collections/Array/initializeArray", "../Random", "../Collections/Enumeration/InfiniteEnumerator", "../Collections/LazyList", "../Collections/Array/areArraysEqual", "../Reflection/isArrayLike", "../Comparison/areEqual", "../Reflection/isString", "../Reflection/numberOrNaN", "../Comparison/compare", "../Collections/Array/copyArray", "../Reflection/isObject"], factory);
    }
})(function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var tslib_1 = require("tslib");
    var enumUtil = require("../Collections/Enumeration/Enumerator");
    ...
    var ArrayEnumerator_1 = require("../Collections/Enumeration/ArrayEnumerator");
    var EnumeratorBase_1 = require("../Collections/Enumeration/EnumeratorBase");
    var Dictionary_1 = require("../Collections/Dictionaries/Dictionary");
    var Queue_1 = require("../Collections/Queue");
    var dispose_1 = require("../Disposable/dispose");
    var DisposableBase_1 = require("../Disposable/DisposableBase");
    var UnsupportedEnumerableException_1 = require("../Collections/Enumeration/UnsupportedEnumerableException");
    var ObjectDisposedException_1 = require("../Disposable/ObjectDisposedException");
    var KeySortedContext_1 = require("../Collections/Sorting/KeySortedContext");
    ...
    var IndexEnumerator_1 = require("../Collections/Enumeration/IndexEnumerator");
    var IteratorEnumerator_1 = require("../Collections/Enumeration/IteratorEnumerator");
    var initializeArray_1 = require("../Collections/Array/initializeArray");
    var Random_1 = require("../Random");
    var InfiniteEnumerator_1 = require("../Collections/Enumeration/InfiniteEnumerator");
    var LazyList_1 = require("../Collections/LazyList");
    var disposeSingle = dispose_1.default.single;
    var areArraysEqual_1 = require("../Collections/Array/areArraysEqual");
    ...
    var numberOrNaN_1 = require("../Reflection/numberOrNaN");
    ...
    var LinqFunctions = /** @class */ (function (_super) {
        tslib_1.__extends(LinqFunctions, _super);
    ...
    var InfiniteLinqEnumerable = /** @class */ (function (_super) {
        tslib_1.__extends(InfiniteLinqEnumerable, _super);
                ...
                return new EnumeratorBase_1.default(function () {
                    ...
                    while (true) {
                        if (enumerator.moveNext()) {
                            ...
                            var e = !isString_1.default(c) && Enumerable.fromAny(c);
                            enumerator = e ? e.getEnumerator() : EmptyEnumerator_1.default;
                    ...
                    try {
                        ...
                        if (enumeratorStack) {
                            dispose_1.default.these.noCopy(enumeratorStack);
        ...
        InfiniteLinqEnumerable.prototype.flatten = function () {
            return this.selectMany(function (entry) {
                var e = !isString_1.default(entry) && Enumerable.fromAny(entry);
        ...
        InfiniteLinqEnumerable.prototype.scan = function (func, seed) {
            ...
            _.throwIfDisposed();
            if (!func)
                throw new ArgumentNullException_1.default("func");
            return (seed === VOID0
        ...
        InfiniteLinqEnumerable.prototype._selectMany = function (collectionSelector, resultSelector) {
            ...
            if (!collectionSelector)
                throw new ArgumentNullException_1.default("collectionSelector");
            ...
            return new LinqEnumerable(function () {
                ...
                return new EnumeratorBase_1.default(function () {
                    ...
                    while (enumerator.moveNext()) {
                        ...
                        else if (areEqual_1.default(compareKey, key)) {
                            continue;
                        }
                        compareKey = key;
        ...
        InfiniteLinqEnumerable.prototype.union = function (second, compareSelector) {
            ...
            return new LinqEnumerable(function () {
                ...
                return new EnumeratorBase_1.default(function () {
                    firstEnumerator = _.getEnumerator();
                    keys = new Dictionary_1.default(compareSelector); // Acting as a HashSet.
                }, function (yielder) {
                    var current;
        ...
        InfiniteLinqEnumerable.prototype.buffer = function (size) {
            ...
            return new LinqEnumerable(function () {
                ...
                return new EnumeratorBase_1.default(function () {
                    ...
                    var array = initializeArray_1.default(size);
                    len = 0;
        ...
        InfiniteLinqEnumerable.prototype.memoize = function () {
            var source = new LazyList_1.default(this);
    ...
    var LinqEnumerable = /** @class */ (function (_super) {
        tslib_1.__extends(LinqEnumerable, _super);
        ...
        LinqEnumerable.prototype.shuffle = function () {
            ...
            return new LinqEnumerable(function () {
                ...
                return new EnumeratorBase_1.default(function () {
                    ...
                    if (!len)
                        return yielder.yieldBreak();
                    var selectedIndex = Random_1.default.integer(len);
        ...
        LinqEnumerable.prototype.contains = function (value, compareSelector) {
            if (compareSelector) {
                ...
                return this.any(function (v) { return areEqual_1.default(compareSelector(v), s_1); });
            }
            return this.any(function (v) { return areEqual_1.default(v, value); });
        };
        ...
        LinqEnumerable.prototype.indexOf = function (value, compareSelector) {
            ...
            this.forEach(compareSelector
                ? function (element, i) {
                    if (areEqual_1.default(compareSelector(element, i), compareSelector(value, i), true)) {
                        found = i;
                        return false;
                    }
                }
                : function (element, i) {
                    ...
                    if (areEqual_1.default(element, value, true)) {
                        found = i;
                        return false;
                    }
                });
        ...
        LinqEnumerable.prototype.intersect = function (second, compareSelector) {
            ...
            _.throwIfDisposed();
            if (!second)
                throw new ArgumentNullException_1.default("second");
            ...
            return new LinqEnumerable(function () {
                ...
                return new EnumeratorBase_1.default(function () {
                    ...
                    while ((hasNext = enumerator.moveNext())) {
                        ...
                        if (areEqual_1.default(compareKey, compareSelector(keySelector(c))))
        ...
        LinqEnumerable.prototype.average = function (selector) {
            if (selector === void 0) { selector = numberOrNaN_1.numberOrNaN; }
            var count = 0;
    ...
    var FiniteEnumerable = /** @class */ (function (_super) {
        tslib_1.__extends(FiniteEnumerable, _super);
    ...
    var ArrayEnumerable = /** @class */ (function (_super) {
        tslib_1.__extends(ArrayEnumerable, _super);
        ...
        ArrayEnumerable.prototype.skip = function (count) {
            ...
            if (!(count > 0))
                return _;
            return new LinqEnumerable(function () { return new ArrayEnumerator_1.default(function () { return _._source; }, count); });
        };
        ...
        ArrayEnumerable.prototype.sequenceEqual = function (second, equalityComparer) {
            if (equalityComparer === void 0) { equalityComparer = areEqual_1.default; }
            if (isArrayLike_1.default(second))
                return areArraysEqual_1.default(this.source, second, true, equalityComparer);
    ...
    (function (Enumerable) {
        ...
        function fromAny(source, defaultEnumerable) {
            if (isObject_1.default(source) || isString_1.default(source)) {
                ...
                if (Enumerator_1.isIterator(source))
                    return fromAny(new IteratorEnumerator_1.default(source));
            }
            else if (typeof source == 'function') {
                return new InfiniteLinqEnumerable(function () { return new InfiniteEnumerator_1.default(source); });
            }
        ...
        function _choice(values) {
            return new InfiniteLinqEnumerable(function () { return new EnumeratorBase_1.default(null, function (yielder) {
                throwIfDisposed(!values);
                return yielder.yieldReturn(Random_1.default.select.one(values));
            }, true // Is endless!
            ); }, function () {
                values.length = 0;
                values = NULL;
        ...
        function choice(values) {
            ...
            return _choice(copyArray_1.default(values));
        }
        ...
        function cycle(values) {
            ...
            return _cycle(copyArray_1.default(values));
        }
        ...
        function repeat(element, count) {
            ...
            return isFinite(count) && Integer_1.default.assert(count, "count")
                ...
                : new LinqEnumerable(function () {
                    return new EnumeratorBase_1.default(null, function (yielder) { return yielder.yieldReturn(element); }, true // Is endless!
                    );
                });
        }
        ...
        function repeatWithFinalize(initializer, finalizer) {
            if (!initializer)
                throw new ArgumentNullException_1.default("initializer");
            return new InfiniteLinqEnumerable(function () {
                var element;
                return new EnumeratorBase_1.default(function () {
                    if (initializer)
        ...
        function generate(factory, count) {
            if (count === void 0) { count = Infinity; }
            if (!factory)
                throw new ArgumentNullException_1.default("factory");
        ...
        (function (random) {
            function floats(maxExclusive) {
                ...
                return generate(Random_1.default.generate(maxExclusive));
            }
            random.floats = floats;
            function integers(boundary, inclusive) {
                return generate(Random_1.default.generate.integers(boundary, inclusive));
            }
        ...
        function weave(enumerables) {
            ...
            return new LinqEnumerable(function () {
                ...
                return new EnumeratorBase_1.default(function () {
                    ...
                    if (queue) {
                        dispose_1.default.these.noCopy(queue.dump());
                        queue = NULL;
                    }
                    if (mainEnumerator)
