...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "./Integer", "./Collections/Array/initializeArray", "./Collections/Array/shuffle"], factory);
    }
    ...
    var assert = Integer_1.default.assert;
    /**
    ...
    (function (Random) {
        ...
        function arrayCopy(source) {
            ...
            var result = initializeArray_1.default(len);
            for (var i = 0; i < len; i++) {
                result[i] = source[i];
            }
            return result;
        ...
        function copy(source) {
            return shuffle_1.default(arrayCopy(source));
        }
        Random.copy = copy;
        /**
        ...
        function select(source, maxCount) {
            ...
            switch (maxCount) {
                ...
                default:
                    var result = shuffle_1.default(arrayCopy(source));
