 ...
 */
define(["require","exports"],function(e,T){"use strict";function t(e){return T.All.indexOf(e)!=-1}T.File="file",T.FTP="ftp",T.GOPHER="gopher",T.HTTP="http",T.HTTPS="https",T.LDAP="ldap",T.MAILTO="mailto",T.PIPE="net.pipe",T.TCP="net.tcp",T.NEWS="news",T.NNTP="nntp",T.TELNET="telnet",T.UUID="uuid",T.All=Object.freeze([T.File,T.FTP,T.GOPHER,T.HTTP,T.HTTPS,T.LDAP,T.MAILTO,T.PIPE,T.TCP,T.NEWS,T.NNTP,T.TELNET,T.UUID]),T.isValid=t});
