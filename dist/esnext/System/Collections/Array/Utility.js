 ...
 * @returns {number}
 */
export function indexOf(array, item, equalityComparer) {
 ...
 * @returns {boolean}
 */
export function contains(array, item, equalityComparer) {
    if (equalityComparer === void 0) { equalityComparer = areEqual; }
 ...
 * @param stop
 */
export function updateRange(array, value, start, stop) {
 ...
 * @param stop
 */
export function clear(array, start, stop) {
    if (start === void 0) { start = 0; }
 ...
 * @returns {boolean}
 */
export function register(array, item, equalityComparer) {
    if (equalityComparer === void 0) { equalityComparer = areEqual; }
    if (!array)
 ...
 */
export function remove(array, value, max, equalityComparer) {
    if (max === void 0) { max = Infinity; }
    if (equalityComparer === void 0) { equalityComparer = areEqual; }
    if (!array || !array.length || max === 0)
        return 0;
 ...
 * @returns {number[]}
 */
export function range(first, count, step) {
 ...
 * @returns {number[]}
 */
export function rangeUntil(first, until, step) {
    if (step === void 0) { step = 1; }
    if (step == 0)
 ...
 * @returns {any[]}
 */
export function flatten(a, recurseDepth) {
