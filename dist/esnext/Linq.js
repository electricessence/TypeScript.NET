...
import { isEnumerable, isEnumerator, isIterator, throwIfEndless } from "./Collections/Enumeration/Enumerator";
...
import InfiniteEnumerator from "./Collections/Enumeration/InfiniteEnumerator";
    ...
    LinqEnumerable.prototype.shuffle = function () {
        ...
        return new LinqEnumerable(function () {
            ...
            return new EnumeratorBase(function () {
                ...
                if (!len)
                    return yielder.yieldBreak();
                var selectedIndex = Random.integer(len);
...
export function Enumerable(source) {
    var additional = [];
