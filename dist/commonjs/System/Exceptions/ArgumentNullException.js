...
var ArgumentNullException = (function (_ArgumentException) {
    _inherits(ArgumentNullException, _ArgumentException);
    ...
    function ArgumentNullException(paramName) {
        ...
        _get(Object.getPrototypeOf(ArgumentNullException.prototype), 'constructor', this).call(this, paramName, message, innerException);
    }
