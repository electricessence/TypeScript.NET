...
var NullReferenceException = (function (_SystemException) {
    _inherits(NullReferenceException, _SystemException);

    function NullReferenceException() {
        _classCallCheck(this, NullReferenceException);

        _get(Object.getPrototypeOf(NullReferenceException.prototype), 'constructor', this).apply(this, arguments);
    }
