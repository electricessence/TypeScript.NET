...
var _SystemCompare = require('../System/Compare');

var Values = _interopRequireWildcard(_SystemCompare);

var _SystemCollectionsArrayCompare = require('../System/Collections/Array/Compare');

var Arrays = _interopRequireWildcard(_SystemCollectionsArrayCompare);

var _SystemCollectionsArrayUtility = require('../System/Collections/Array/Utility');

var ArrayUtility = _interopRequireWildcard(_SystemCollectionsArrayUtility);
...
var _SystemInteger = require('../System/Integer');

var _SystemInteger2 = _interopRequireDefault(_SystemInteger);

var _SystemFunctions = require('../System/Functions');

var _SystemFunctions2 = _interopRequireDefault(_SystemFunctions);

var _SystemCollectionsEnumerationArrayEnumerator = require('../System/Collections/Enumeration/ArrayEnumerator');

var _SystemCollectionsEnumerationArrayEnumerator2 = _interopRequireDefault(_SystemCollectionsEnumerationArrayEnumerator);

var _SystemCollectionsEnumerationEnumeratorBase = require('../System/Collections/Enumeration/EnumeratorBase');

var _SystemCollectionsEnumerationEnumeratorBase2 = _interopRequireDefault(_SystemCollectionsEnumerationEnumeratorBase);

var _SystemCollectionsDictionariesDictionary = require('../System/Collections/Dictionaries/Dictionary');

var _SystemCollectionsDictionariesDictionary2 = _interopRequireDefault(_SystemCollectionsDictionariesDictionary);
...
var _SystemDisposableUtility = require('../System/Disposable/Utility');
...
var LinqFunctions = (function (_BaseFunctions) {
    ...
    function LinqFunctions() {
        ...
        _get(Object.getPrototypeOf(LinqFunctions.prototype), 'constructor', this).apply(this, arguments);
    }
...
var Enumerable = (function (_DisposableBase) {
    ...
    function Enumerable(_enumeratorFactory, finalizer) {
        ...
        _get(Object.getPrototypeOf(Enumerable.prototype), 'constructor', this).call(this, finalizer);
    ...
    _createClass(Enumerable, [{
        ...
        value: function forEach(action) {
            ...
            _.throwIfDisposed();
            var index = 0;
            (0, _SystemDisposableUtility.using)(_.getEnumerator(), function (e) {
        ...
        value: function toLookup(keySelector) {
            ...
            var dict = new _SystemCollectionsDictionariesDictionary2['default'](compareSelector);
        ...
        value: function doAction(action) {
            ...
            return new Enumerable(function () {
                ...
                return new _SystemCollectionsEnumerationEnumeratorBase2['default'](function () {
                    ...
                    (0, _SystemDisposableUtility.dispose)(enumerator);
                });
            }, function () {
                disposed = true;
            });
        ...
        value: function skip(count) {
            ...
            _SystemInteger2['default'].assert(count, "count");
            var c = count;
        ...
        value: function takeExceptLast() {
            ...
            return new Enumerable(function () {
                ...
                return new _SystemCollectionsEnumerationEnumeratorBase2['default'](function () {
                    enumerator = _.getEnumerator();
                    q = new _SystemCollectionsQueue2['default']();
                }, function (yielder) {
                    while (enumerator.moveNext()) {
                    ...
                    (0, _SystemDisposableUtility.dispose)(enumerator, q);
                });
            });
        }
    }, {
            ...
            return new Enumerable(function () {
                ...
                return new _SystemCollectionsEnumerationEnumeratorBase2['default'](function () {
                    ...
                    try {
                        ...
                        (0, _SystemDisposableUtility.disposeThese)(enumeratorStack);
                    }
                });
            });
        }
        ...
        value: function flatten() {
            ...
            return new Enumerable(function () {
                ...
                return new _SystemCollectionsEnumerationEnumeratorBase2['default'](function () {
                    ...
                    (0, _SystemDisposableUtility.dispose)(enumerator, middleEnumerator);
                });
            });
        }
    }, {
        ...
        value: function selectMany(collectionSelector, resultSelector) {
            var _ = this;
            if (!resultSelector) resultSelector = function (a, b) {
                return b;
            };
            return new Enumerable(function () {
                var enumerator;
        ...
        value: function ofType(type) {
            ...
            switch (type) {
                case Number:
                    typeName = _SystemTypes2['default'].NUMBER;
                    break;
                case String:
                    typeName = _SystemTypes2['default'].STRING;
                    break;
                case Boolean:
                    typeName = _SystemTypes2['default'].BOOLEAN;
                    break;
                case Function:
        ...
        value: function shuffle() {
            ...
            return new Enumerable(function () {
                ...
                return new _SystemCollectionsEnumerationEnumeratorBase2['default'](function () {
                    ...
                    if (!len) return yielder.yieldBreak();
                    var selectedIndex = _SystemInteger2['default'].random(len);
        ...
        value: function zip(second, resultSelector) {
            ...
            return new Enumerable(function () {
                ...
                return new _SystemCollectionsEnumerationEnumeratorBase2['default'](function () {
                    ...
                    (0, _SystemDisposableUtility.dispose)(firstEnumerator, secondEnumerator);
                });
            });
        }
    }, {
        ...
        value: function zipMultiple(second, resultSelector) {
            ...
            return new Enumerable(function () {
                ...
                var index = 0;
                return new _SystemCollectionsEnumerationEnumeratorBase2['default'](function () {
                    secondTemp = new _SystemCollectionsQueue2['default'](second);
                    index = 0;
                    firstEnumerator = _.getEnumerator();
                    ...
                    (0, _SystemDisposableUtility.dispose)(firstEnumerator, secondTemp);
                });
            });
        }
    }, {
        ...
        value: function join(inner, outerKeySelector, innerKeySelector, resultSelector) {
            ...
            return new Enumerable(function () {
                ...
                return new _SystemCollectionsEnumerationEnumeratorBase2['default'](function () {
                    ...
                    (0, _SystemDisposableUtility.dispose)(outerEnumerator);
                });
            });
        }
    }, {
        ...
        value: function merge(enumerables) {
            ...
            return new Enumerable(function () {
                ...
                return new _SystemCollectionsEnumerationEnumeratorBase2['default'](function () {
                    enumerator = _.getEnumerator();
                    queue = new _SystemCollectionsQueue2['default'](enumerables);
                }, function (yielder) {
                    while (true) {
                    ...
                    (0, _SystemDisposableUtility.dispose)(enumerator, queue);
                });
            });
        }
    }, {
        ...
        value: function insertAt(index, other) {
            ...
            _SystemInteger2['default'].assert(index, "index");
            var n = index;
            var _ = this;
            _.throwIfDisposed();
            return new Enumerable(function () {
        ...
        value: function alternateMultiple(sequence) {
            ...
            return new Enumerable(function () {
                ...
                return new _SystemCollectionsEnumerationEnumeratorBase2['default'](function () {
                    alternateEnumerator = new _SystemCollectionsEnumerationArrayEnumerator2['default'](Enumerable.toArray(sequence));
                    enumerator = _.getEnumerator();
                    ...
                    (0, _SystemDisposableUtility.dispose)(enumerator, alternateEnumerator);
                });
            });
        }
    }, {
        ...
        value: function intersect(second, compareSelector) {
            ...
            return new Enumerable(function () {
                ...
                return new _SystemCollectionsEnumerationEnumeratorBase2['default'](function () {
                    enumerator = _.getEnumerator();
                    keys = new _SystemCollectionsDictionariesDictionary2['default'](compareSelector);
                    outs = new _SystemCollectionsDictionariesDictionary2['default'](compareSelector);
        ...
        value: function sequenceEqual(second) {
            ...
            return (0, _SystemDisposableUtility.using)(this.getEnumerator(), function (e1) {
                return (0, _SystemDisposableUtility.using)(Enumerable.from(second).getEnumerator(), function (e2) {
                    while (e1.moveNext()) {
        ...
        value: function buffer(size) {
            ...
            _SystemInteger2['default'].assert(size, "size");
            var _ = this,
                len;
            return new Enumerable(function () {
                var enumerator;
        ...
        value: function average() {
            var selector = arguments.length <= 0 || arguments[0] === undefined ? _SystemTypes2['default'].numberOrNaN : arguments[0];
        ...
        value: function share() {
            ...
            return new Enumerable(function () {
                ...
                (0, _SystemDisposableUtility.dispose)(sharedEnumerator);
            });
        }
    }, {
        key: 'memoize',
        ...
        value: function choice(values) {
            return new Enumerable(function () {
                return new _SystemCollectionsEnumerationEnumeratorBase2['default'](null, function (yielder) {
                    return yielder.yieldReturn(values[_SystemInteger2['default'].random(values.length)]);
                });
            });
        }
    }, {
        ...
        value: function empty() {
            return new Enumerable(function () {
                return new _SystemCollectionsEnumerationEnumeratorBase2['default'](null, Functions.False);
            });
        }
    }, {
        key: 'repeat',
        value: function repeat(element) {
            ...
            return isFinite(count) && _SystemInteger2['default'].assert(count, "count") ? new Enumerable(function () {
                var c = count;
                var index = 0;
                return new _SystemCollectionsEnumerationEnumeratorBase2['default'](function () {
                    index = 0;
        ...
        value: function rangeTo() {
            ...
            return new Enumerable(function () {
                var value;
                return start < to ? new _SystemCollectionsEnumerationEnumeratorBase2['default'](function () {
                    value = start;
                }, function (yielder) {
                    var result = value <= to && yielder.yieldReturn(value);
                    if (result) value += step;
                    return result;
                }) : new _SystemCollectionsEnumerationEnumeratorBase2['default'](function () {
                    value = start;
                }, function (yielder) {
                    var result = value >= to && yielder.yieldReturn(value);
                    if (result) value -= step;
...
var ArrayEnumerable = (function (_Enumerable) {
    ...
    function ArrayEnumerable(source) {
        ...
        _get(Object.getPrototypeOf(ArrayEnumerable.prototype), 'constructor', this).call(this, function () {
            _.throwIfDisposed();
            return new _SystemCollectionsEnumerationArrayEnumerator2['default'](function () {
...
var Grouping = (function (_ArrayEnumerable) {
    ...
    function Grouping(_groupKey, elements) {
        ...
        _get(Object.getPrototypeOf(Grouping.prototype), 'constructor', this).call(this, elements);
...
var WhereEnumerable = (function (_Enumerable2) {
    ...
    function WhereEnumerable(prevSource, prevPredicate) {
        ...
        _get(Object.getPrototypeOf(WhereEnumerable.prototype), 'constructor', this).call(this, null);
...
var WhereSelectEnumerable = (function (_Enumerable3) {
    ...
    function WhereSelectEnumerable(prevSource, prevPredicate, prevSelector) {
        ...
        _get(Object.getPrototypeOf(WhereSelectEnumerable.prototype), 'constructor', this).call(this, null);
        this.prevSource = prevSource;
        this.prevPredicate = prevPredicate;
...
function throwIfDisposed(disposed) {
    ...
    if (disposed) throw new _SystemDisposableObjectDisposedException2['default'](className);
}
