(function (factory) {
    if (typeof module === 'object' && typeof module.exports === 'object') {
        ...
        define(["require", "exports", "./constants/Paths", "gulp", "../source/System/Promises/Promise", "../_utility/stream-to-promise", "../source/mergeValues"], factory);
    }
    ...
    function fromTo(from, to, target, module, declaration, doNotEmit) {
        ...
        var start = declaration
            ? stream_to_promise_1.streamToPromise.toPromise(gulp
                .src([from + '/**/*.d.ts'])
                .pipe(gulp.dest(to)))
            : Promise_1.Promise.resolve();
        return start.then(function () { return stream_to_promise_1.streamToPromise.toPromise(gulp
            .src([from + '/**/*.ts'])
