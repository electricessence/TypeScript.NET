...
class LinkedList<T> implements ICollection<T>, IEnumerateEach<T>
{
	...
	// Clone's the collection before executing the for each.
	// forEachFromClone(action:Predicate<T>):void;
	// forEachFromClone(action:Action<T>):void;
