    ...
    (function (Linq) {
        ...
        var Enumerable = (function (_super) {
            ...
            Enumerable.cycle = function (values) {
                return new Enumerable(function () {
                    var index;
                    return new EnumeratorBase(function () { return index = 0; }, function (yielder) {
            ...
            Enumerable.repeatWithFinalize = function (initializer, finalizer) {
                return new Enumerable(function () {
                    var element;
                    return new EnumeratorBase(function () { return element = initializer(); }, function (yielder) { return yielder.yieldReturn(element); }, function () {
                        if (element != null) {
                            finalizer(element);
                            element = null;
                        }
            ...
            Enumerable.rangeTo = function (start, to, step) {
                ...
                return new Enumerable(function () {
                    var value;
                    return start < to
                        ? new EnumeratorBase(function () { return value = start - step; }, function (yielder) {
                            var next = value += step;
                            return (next <= to)
            ...
            Enumerable.matches = function (input, pattern, flags) {
                ...
                return new Enumerable(function () {
                    var regex;
                    return new EnumeratorBase(function () { return regex = new RegExp(pattern, flags); }, function (yielder) {
            ...
            Enumerable.defer = function (enumerableFactory) {
                return new Enumerable(function () {
                    var enumerator;
                    return new EnumeratorBase(function () { return enumerator = enumerableFactory().getEnumerator(); }, function (yielder) {
                        return (enumerator.moveNext())
                            ? yielder.yieldReturn(enumerator.current)
                            : yielder.yieldBreak();
                    }, function () { return enumerator.dispose(); });
                });
            };
            ...
            Enumerable.prototype.toArray = function (predicate) {
                ...
                this.forEach(function (x) { return result.push(x); });
                return result;
            };
            ...
            Enumerable.prototype.toMap = function (keySelector, elementSelector) {
                var obj = {};
                this.forEach(function (x) { return obj[keySelector(x)] = elementSelector(x); });
                return obj;
            };
            ...
            Enumerable.prototype.skip = function (count) {
                ...
                return (!count || count < 0)
                    ? this.asEnumerable()
                    : this.doAction(function (element, index) {
                        return index < count
            ...
            Enumerable.prototype.take = function (count) {
                ...
                return (!count || count < 0)
                    ? Enumerable.empty()
                    : this.doAction(function (element, index) { return index < count; });
            };
            ...
            Enumerable.prototype.takeFromLast = function (count) {
                ...
                return new Enumerable(function () {
                    ...
                    }, function (yielder) { return enumerator.moveNext() && yielder.yieldReturn(enumerator.current); }, function () { return enumerator.dispose(); });
                });
            };
            ...
            Enumerable.prototype.reverse = function () {
                ...
                return new Enumerable(function () {
                    ...
                    }, function () { return buffer.length = 0; });
                }, function () { return disposed = true; });
            };
        ...
        var ArrayEnumerable = (function (_super) {
            ...
            ArrayEnumerable.prototype.first = function (predicate) {
                ...
                return (source && source.length && !predicate)
                    ? source[0]
                    : _super.prototype.first.call(this, predicate);
            };
            ArrayEnumerable.prototype.firstOrDefault = function (predicate, defaultValue) {
                ...
                return (source && source.length)
                    ? (predicate ? _super.prototype.firstOrDefault.call(this, predicate, defaultValue) : source[0])
                    : defaultValue;
            };
            ArrayEnumerable.prototype.last = function (predicate) {
                ...
                return (len && !predicate)
                    ? source[len - 1]
                    : _super.prototype.last.call(this, predicate);
            };
            ArrayEnumerable.prototype.lastOrDefault = function (predicate, defaultValue) {
                ...
                var source = this._source, len = source.length;
                return len
                    ? (predicate ? _super.prototype.firstOrDefault.call(this, predicate, defaultValue) : source[len - 1])
                    : defaultValue;
            };
            ArrayEnumerable.prototype.skip = function (count) {
                ...
                return (!count || count < 0)
                    ? _.asEnumerable()
                    : new Enumerable(function () { return new System.Collections.ArrayEnumerator(function () { return _._source; }, count); });
            };
        ...
        var WhereEnumerable = (function (_super) {
            ...
            WhereEnumerable.prototype.getEnumerator = function () {
                ...
                var enumerator;
                return new System.Collections.EnumeratorBase(function () { enumerator = source.getEnumerator(); }, function (yielder) {
                    while (enumerator.moveNext())
        ...
        var Lookup = (function () {
            ...
            Lookup.prototype.getEnumerator = function () {
                var _ = this;
                var enumerator;
                return new System.Collections.EnumeratorBase(function () { return enumerator = _._dictionary.getEnumerator(); }, function (yielder) {
                    if (!enumerator.moveNext())
                        return false;
                    var current = enumerator.current;
